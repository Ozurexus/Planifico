...
import type { AuthProvider, Client } from '@microsoft/microsoft-graph-client';
...
import {
  endOfWeek, startOfWeek, add, format, getDay, parseISO,
} from 'date-fns';
import { msalInstance, signOut } from './authService';
import {
  createEvent, getUser, getUserYearCalendar, deleteEvent,
} from './graph';
...
export async function newEventCalendar(
  account: AccountInfo,
  date: Date,
  event: CalendarEvent,
): Promise<void> {
